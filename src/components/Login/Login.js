           ...
           <div >
            ...
            <div className='flex flex-wrap login w-60  bg-light-gray o-80 br4 shadow-5-ns shadow-3' >
              <form className='form w-50-ns w-100 center ma4 '>
                  <p className="register  center ma2 pa2 f1-ns f2 fw9">Sign In</p>
                  ...
                  <p onClick={()=>onSubmit('home')} className='w-30-ns w-50 f5 fw7gray tc center mb2 mt3 pa2 pointer ba bg-white bw2 link dim dib b--gray  br-pill shadow-5-ns shadow-3'>Sign In</p>
              </form>         
            </div>
